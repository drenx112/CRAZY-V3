...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "CRAZY;;;nExSCYra#NAyy3OACoD5VCYv3GIesZBiR6v_DXGkDLZfyHFFZjg0",
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY 𝐷𝐵𝑌✯-V3 🎉*",
...
BOT_NAME: process.env.BOT_NAME || "𝐷𝐵𝑌✯-MD-V3",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*©powered by 𝐷𝐵𝑌✯*",
// add bot owner name    
...
DEV: process.env.DEV || "263710781795",
